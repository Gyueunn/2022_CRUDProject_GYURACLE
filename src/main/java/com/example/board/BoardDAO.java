...
//        return template.update(CLASSLIST_UPDATE, new Object[]{vo.getTitleName(), vo.getProfessor(), vo.getSection(), vo.getCredits(), vo.getType(), vo.getClassTime(), vo.getCategory(), vo.getEnglish(), vo.getSeq()});
        int result = sqlSession.insert("ClassList.updateClassList", vo);
        return result;
    }
...
//        return template.update(CLASSLIST_DELETE, new Object[]{id});
        int result = sqlSession.insert("ClassList.deleteClassList", id);
        return result;
    }
